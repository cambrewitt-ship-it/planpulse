...
export async function GET() {
  ...
  try {
    ...
    const listUrl = 'https://googleads.googleapis.com/v25/customers:listAccessibleCustomers';
    ...
    if (savedAccounts) {
      for (const account of savedAccounts) {
        ...
        const searchUrl = `https://googleads.googleapis.com/v25/customers/${account.customer_id}/googleAds:search`;
