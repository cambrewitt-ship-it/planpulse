...
export async function GET() {
  ...
  try {
    ...
    const listCustomersUrl = 'https://googleads.googleapis.com/v25/customers:listAccessibleCustomers';
    ...
    if (cleanMccId) {
      try {
        ...
        const mccSearchUrl = `https://googleads.googleapis.com/v25/customers/${cleanMccId}/googleAds:search`;
    ...
    if (accessibleCustomerIds.length > 0) {
      ...
      const searchUrl = `https://googleads.googleapis.com/v25/customers/${testCustomerId}/googleAds:search`;
    ...
    for (const account of activeAccounts) {
      ...
      if (!isInAccessibleList) {
        ...
        const testUrl = `https://googleads.googleapis.com/v25/customers/${cleanCustomerId}/googleAds:search`;
